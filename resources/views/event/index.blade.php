...
<section id="explore" class="container py-5 mt-5">
    <div class="mb-5">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4 mb-5">
            <div>
                <h2 class="fw-bold mb-1">Semua Event</h2>
                <p class="text-secondary">Temukan berbagai event menarik yang sesuai dengan minatmu.</p>
            </div>

            <div class="search-container">
                <form id="search-form" class="d-flex bg-glass p-2 rounded-pill border border-secondary shadow-sm">
                    <div class="input-group">
                        <span class="input-group-text bg-transparent border-0 text-secondary ps-3">
                            <i class="fa-solid fa-magnifying-glass"></i>
                        </span>
                        <input type="text" name="search" class="form-control border-0 bg-transparent text-white px-2" placeholder="Cari judul event..." autocomplete="off">
                        <button type="submit" class="btn btn-primary-gradient rounded-pill px-4">Cari</button>
                    </div>
                </form>
            </div>
        </div>
