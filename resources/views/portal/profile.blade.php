    ...
    <div class="col-lg-4">
        <div class="card shadow-sm border-0 h-100">
            <div class="card-body text-center pt-15">
                <div class="mb-7">
                    <div class="image-input image-input-outline image-input-placeholder" id="profile-avatar-wrapper">
                        <div class="image-input-wrapper w-150px h-150px rounded-circle shadow-sm" 
                             style="background-image: url('{{ auth()->user()->avatar ?? asset('assets/media/avatars/blank.png') }}')"></div>
                ...
                <span class="badge badge-light-primary fw-bold px-4 py-2 mb-7">{{ auth()->user()->role->name ?? 'Mitra Instansi' }}</span>
    ...
    <div class="col-lg-8">
            ...
            <form id="form-profile-basic">
                <div class="card-body p-9">
                    <div class="row g-6">
                        ...
                        <div class="col-md-6">
                            <x-forms.input type="text" name="username" label="Username" value="{{ auth()->user()->username }}"></x-forms.input>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9 bg-light-faint rounded-bottom">
                    <x-button type="submit" color="primary" indicator>Simpan Profil</x-button>
                </div>
            </form>
        </div>
        ...
        <div class="card shadow-sm border-0">
            ...
            <form id="form-profile-password">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9 bg-light-faint rounded-bottom">
                    <x-button type="submit" color="warning" indicator>Update Password</x-button>
                </div>
            </form>
        </div>
    </div>
