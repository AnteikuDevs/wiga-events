...
let WigaClass = Wiga.class({
                ...
                { data: function(data){
                    ...
                    if(data.attendance)
                    {
                        userActions.push({
                            ...
                            href: WigaRoute.url('/certificate/cert-'+btoa(data.attendance.id).replace(/\+/g, '=')),
                            // events: {
                            //     click: function(e) {
    ...
    async store()
    {
        ...
        let response = await WigaHttp.post('/admin/events/'+eventID+'/participants', WigaForm.data('#ModalForm form'));
    ...
    async update()
    {
        ...
        let response = await WigaHttp.post('/admin/events/'+eventID+'/participants'+'/'+$wiga('#ModalForm').attr('data-id'), data);
        WigaHttp.handle(response,'#ModalForm form',function(res) {
            $wiga('#ModalForm').modal('hide');
            WigaClass.render();
            WigaNotify.showInline('#wiga-alert',{
    ...
    async delete()
    {
        ...
        let response = await WigaHttp.delete('/admin/events/'+eventID+'/participants'+'/'+$wiga('#ModalDelete').attr('data-id'));
